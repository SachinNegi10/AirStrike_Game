# Air Strike
# Hii there👋😊
Welcome to Airstrike game. Air Strike is an engaging 2D arcade-style game developed in Java using the Swing library. Dive into the action with this fast-paced arcade game where your mission is to protect your base from the attack of descending enemies. As the sole defender, you must maneuver left and right to dodge incoming attacks and retaliate to eliminate the threat.
